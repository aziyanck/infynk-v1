...
const UserDashboard = () => {
  ...
  useEffect(() => {
    const close = (e) =>
      e.target.closest(".relative") || setShowThemePop(false);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-2 sm:p-6">
      {/* Header */}
      <header
        className="w-full max-w-4xl  rounded-2xl shadow-md p-4 mb-6 flex justify-between items-center"
        style={{ backgroundColor: bg }}
      >
        <h1 className="text-2xl font-bold text-gray-800">Pixiic.</h1>
        <div className="flex items-center space-x-4">
          <div
            className="w-8 h-8 bg-blue-500 text-white flex items-center justify-center rounded-md font-bold shadow-sm"
            title="Profile view"
          >
            {profile.view_count}
          </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <img
                      src={
                        localImage ||
                        profile.pr_img ||
                        "https://placehold.co/150x150/A78BFA/ffffff?text=JD"
                      }
                      alt="avatar"
      ...
      {/* Main Content */}
      <div
        className="w-full max-w-4xl rounded-2xl shadow-md p-4 mb-20"
        style={{ backgroundColor: bg }}
      >
        {/* Profile Image */}
        <div className="flex flex-col items-center mb-8">
          <div
            className="relative w-32 h-32 rounded-full overflow-hidden mb-4 border-4  shadow-lg"
          ...
          >
            ...
            <label
              ...
              className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white opacity-0 hover:opacity-100 transition-opacity duration-300 cursor-pointer z-20"
            >
              Upload
            </label>
            <input
          ...
          <h2 className="text-3xl font-semibold " style={{ color: txtclr }}>
            {profile.name}
          </h2>
        ...
        >
          <h3 className="text-xl font-semibold mb-4" style={{ color: txtclr }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <textarea
              ...
              onChange={handleProfileChange}
              rows="3"
              className="border p-2 rounded col-span-full bg-white/90"
              placeholder="Bio"
            />
          </div>
        </div>
        ...
        {/* Pinned Fields */}
        <div
          className="mb-8 p-4  rounded-xl shadow-inner space-y-4"
          style={{ backgroundColor: lightbg }}
        >
          <EditableField
            label="Phone"
      ...
      {showPreview && (
        <div className="fixed inset-0 z-[100] bg-white overflow-y-auto">
            ...
            {showPreviewThemePop && (
              <>
                <div
                  ...
                  onClick={() => setShowPreviewThemePop(false)}
                />
          ...
          <button
            ...
            disabled={saving}
            className={`fixed bottom-6 right-6 z-[101] text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center ${
              saving ? "opacity-70 cursor-not-allowed" : ""
            }`}
